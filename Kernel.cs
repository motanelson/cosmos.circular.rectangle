...
namespace Cosmosround
{
...

    {
        ...
        public static void mainLoop()
        {
            ...
            graf.canvas.DrawFilledRectangle(p, 640 / 2-75/2, 480 / 2-50, 75,100);
            graf.canvas.DrawFilledRectangle(p, 640 / 2 - 50, 480 / 2 - 75/2, 100, 75);
            graf.canvas.DrawFilledCircle(p, new Sys.Graphics.Point(640 / 2 - 50 / 2-12, 480 / 2 - 50+11), 12);
            graf.canvas.DrawFilledCircle(p, new Sys.Graphics.Point(640 / 2 + 50 / 2+12, 480 / 2 + 50 - 11), 12);
            graf.canvas.DrawFilledCircle(p, new Sys.Graphics.Point(640 / 2 + 50  / 2+12, 480 / 2 - 50 + 11), 12);
            graf.canvas.DrawFilledCircle(p, new Sys.Graphics.Point(640 / 2 - 50  / 2-12, 480 / 2 + 50 - 11), 12);
